...
import at.tewan.mcpc.language.mcfunction.parser.MCFunctionParser;
import at.tewan.mcpc.language.mcfunction.psi.MCFunctionFile;
...
public class MCFunctionParserDefinition implements ParserDefinition {
	...
	public static final TokenSet COMMENTS = TokenSet.create(MCFunctionTypes.COMMENT);
